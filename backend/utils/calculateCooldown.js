// 쿨타임 계산식
function calculateCooldown(baseCooldown, trainLevel) {
  ...
  const rawCooldown = baseCooldown * multiplier;
  const gameCooldown = rawCooldown * gameTimeFactor;

  return parseFloat(gameCooldown.toFixed(3));
}
